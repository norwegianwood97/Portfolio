...
const CAREER = {
  ...
  stack: 'Java · JSP · Spring · JavaScript · PostgreSQL · SVN/GitLab · Git · Python · AWS',
  items: [
    {
      title: '백엔드 유지보수',
...
const TRAINING = [
  { title: '팀스파르타 항해99 백엔드 Node.js 과정 수료', date: '2024.02 — 2024.07' },
    ...
    <PageShell active="Experience">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-4 md:gap-6">
        ...
        <div className="bg-ink-900 border border-ink-700 rounded-xl p-5 sm:p-6">
          ...
          <h3 className="text-lg font-medium text-ink-100 mb-1">{CAREER.company}</h3>
